                ...
                <a-skeleton active :loading="loading">
                    <a-card>
                        ...
                        <template class="ant-card-actions" #actions>
                            <div @click="showForm(faculty.id)"><svg viewBox="64 64 896 896" data-icon="edit" width="1em" height="1em" fill="currentColor" aria-hidden="true" focusable="false" class="">
                            ...
                            <a-popconfirm :title="'Уверены, что хотите удалить '+faculty.name+ '?'" ok-text="Да" cancel-text="Нет" @confirm="deleteInstance(faculty.id)">
